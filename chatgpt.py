...
★ ᴘʀᴏᴍᴏᴛᴇ ʙʏ : [𝗧𝗙𝗖](https://t.me/tfc bots)
...
MAIN = [
    [
        InlineKeyboardButton(text="🥺Aᴡᴡ ʙᴀʙʏ ᴀᴅᴅ ᴍᴇ🥺" , url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
     ],
     [
        InlineKeyboardButton(text="♥️ Cʜᴀᴛᴛɪɴɢ ♥️", url=f"https://t.me/TheFriendsChatting"),
        InlineKeyboardButton(text="♥ ʜᴇʟᴘ & ᴄᴍᴅs ♥", callback_data="HELP"),
    ],
    [
        InlineKeyboardButton(text="乛𝒙𝑫 ۵ [🇮🇳]", url=f"https://t.me/Btw_Devx"),
        InlineKeyboardButton(text="🔥 ᴏᴡɴᴇʀ 🔥", url=f"https://t.me/Nikk_xd"),
    ],
]
X = [
    [
...
if SOURCE != s:
    print("ᴋᴀʀ ʟɪʏᴀ ᴇᴅɪᴛᴍɪʟ ɢᴀʏᴀ ꜱᴜᴋᴏᴏɴ ᴊᴇꜱᴀ ᴛʜᴀ ᴡᴇꜱᴀ ᴋᴀʀᴅᴇ ` https://github.com/itsdevxd/TFC-CHATGPT")
if __name__ == "__main__":
    ...
    print(f"""JOIN [🍑 ⋆ ʏᴏᴜʀ TFC ᴄʜᴀᴛɢᴘᴛ ʙᴏᴛ ꜱᴛᴀʀᴛ ⋆ 🍑]
    ★·.·´¯`·.·★ᴛʜɪꜱ ʀᴇᴘᴏ ᴍᴀᴅᴇ ʙʏ [乛𝒙𝑫 ۵ [🇮🇳]](https://t.me/btw_devx) ★·.·´¯`·.·★
 {BOT_NAME} ɪs ᴀʟɪᴠᴇ!  
    """)
    idle()
    BRANDED.stop()
    print("*☆* TFC ᴄʜᴀᴛɢᴘᴛ ʙᴏᴛ ꜱᴛᴀʀᴛ ᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴜꜱɪɴɢ ᴛʜɪꜱ ʀᴇᴘᴏ @II_SPOTIFY_BOT @TheFriendsChatting @TFCbots @NIKK_XD @Btw_DeVx *☆* !")
